...
const Cart = () => {
    return <div  className="min-h-[calc(100vh_-_433px)]">
        <div className="grid lg:grid-cols-[minmax(1000px,5fr)_min(200px, 1fr)]
        grid-cols-[_minmax(1000px,3fr)_minmax(240px,_1fr)] min-h-[calc(100vh_-_433px)]">
            <div className="md:min-h-[calc(100vh_-_433px)] flex items-center justify-center px-10 overflow-x-auto w-full ">
            ...
            <div className="bg-secondary text-tertiary grid place-content-center gap-5">
                ...
                <button className="btn-primary mt-4 md:w-auto w-52 text-center">CHECKOUT NOW!</button>
            </div>
        </div>
    </div>
}
